...
const StreamingView = ({ 
    ...
    const handleToggleMode = () => {
        ...
        updateStreamParam('immersiveType', streamParams.immersiveType === 'xr' ? 'mr' : 'xr');
    };
            ...
            <div className="flex-1 flex overflow-hidden">
                <div className="flex-1 bg-black relative flex items-center justify-center overflow-hidden">
                        ...
                        {streamParams.schemeCompareActive && (
                            <div className="absolute inset-0 flex animate-in fade-in">
                                <div className="w-1/2 h-full border-r-2 border-white/50 relative">
                                    <div className="absolute bottom-4 left-4 text-white font-bold text-shadow bg-black/30 px-2 rounded">方案 A</div>
                                </div>
                                <div className="w-1/2 h-full relative">
                                    <div className="absolute bottom-4 right-4 text-white font-bold text-shadow bg-black/30 px-2 rounded">方案 B (Node: {streamParams.schemeIp})</div>
                                </div>
                            </div>
                        )}
                </div>
