...
export interface ApiMachineMachine extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    current_project: Schema.Attribute.Relation<
      'manyToOne',
      'api::project.project'
    >;
    health: Schema.Attribute.Enumeration<['good', 'bad']> &
    ...
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['idle', 'running', 'offline']> &
...
export interface ApiProcessProcess extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    status: Schema.Attribute.Enumeration<
      ['starting', 'running', 'stopped', 'error', 'terminated']
    > &
      Schema.Attribute.DefaultTo<'starting'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
