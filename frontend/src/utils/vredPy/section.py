...
class SectionTool:
    def __init__(self):
        ...
        self.rightController.addVirtualButton(padCenter, 'joystick')
        self.rightController.addVirtualButton(padUpperLeft, 'joystick')
        self.rightController.addVirtualButton(padLowerLeft, 'joystick')
        self.rightController.addVirtualButton(padUp, 'joystick')
        self.rightController.addVirtualButton(padUpperRight, 'joystick')
        self.rightController.addVirtualButton(padLowerRight, 'joystick')
        self.rightController.addVirtualButton(padDown, 'joystick')
        ...
        teleport.setControllerActionMapping("prepare", "left-joystick-touched")
        teleport.setControllerActionMapping("abort", "left-joystick-untouched")
        teleport.setControllerActionMapping("execute", "left-joystick-pressed")
